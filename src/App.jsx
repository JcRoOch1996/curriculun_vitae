    ...
    <div className="min-h-screen bg-white">
      <main className="max-w-3xl mx-auto p-8 text-gray-900 font-serif">
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold border-b border-gray-200 pb-1 mb-2">Perfil Profesional</h2>
          <p>
        ...
        {/* Formación Académica */}
        <section className="mb-6">
          <h2 className="text-2xl font-semibold border-b border-gray-200 pb-1 mb-2">Formación Académica</h2>
        ...
        {/* Experiencia Laboral */}
        <section className="mb-6">
          <h2 className="text-2xl font-semibold border-b border-gray-200 pb-1 mb-2">Experiencia Laboral</h2>
          <div className="mb-4">
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold border-b border-gray-200 pb-1 mb-2">Habilidades Técnicas</h2>
          <p><strong>Frontend:</strong> HTML, CSS, JavaScript, React, Angular, Astro, Bootstrap</p>
          <p><strong>Backend:</strong> JavaScript, TypeScript, Python, ExpressJs, NestJs, Django, Flask</p>
        </section>

        {/* Habilidades Blandas */}
        <section className="mb-6">
          <h2 className="text-2xl font-semibold border-b border-gray-200 pb-1 mb-2">Habilidades Blandas</h2>
          <p>Trabajo en equipo, comunicación efectiva, responsabilidad, compromiso, aprendizaje autónomo</p>
        </section>

        {/* Idiomas */}
        <section className="mb-6">
          <h2 className="text-2xl font-semibold border-b border-gray-200 pb-1 mb-2">Idiomas</h2>
          <p><strong>Español:</strong> Nativo</p>
          <p><strong>Inglés:</strong> Nivel A1 (lectura y escritura de frases simples, presentaciones básicas)</p>
        </section>

        {/* Áreas de Interés */}
        <section className="mb-6">
          <h2 className="text-2xl font-semibold border-b border-gray-200 pb-1 mb-2">Áreas de Interés</h2>
